...
define(['node_modules/js-fixtures/fixtures', 'jquery', 'module'], function (fixtures, $, module) {
  ...
  describe('Test Bar Chart with threshold bar UI lights-off', function(){
    var $$;
    before(function(done) {
      ...
      fixtures.load('threshold-bar-lights-off.html', function() {
    ...
    after(function(){
      ...
      /*it('Should have dashed bar with black color', function() {
		  expect( toHex($$('#threshold-bar-chart.threshold-bar').css("color")) ).to.equal('#f3f3f3');
      });*/
  });
});
