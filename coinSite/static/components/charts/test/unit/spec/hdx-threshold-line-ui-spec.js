...
define(['node_modules/js-fixtures/fixtures', 'jquery', 'module'], function (fixtures, $, module) {
  ...
  describe('Test Line Chart with threshold line', function(){
    var $$;
    before(function(done) {
      ...
      fixtures.load('threshold-line.html', function() {
    ...
    after(function(){
      ...
      it('Should have dashed line with black color', function() {
        expect( toHex($$('#threshold-line-chart.threshold-bar').css("color")) ).to.equal('#131313');
      });
